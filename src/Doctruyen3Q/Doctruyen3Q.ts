...
const DOMAIN = 'https://doctruyen3qme.com/'
const method = 'GET'
...
export class Doctruyen3Q extends Source {
    ...
    async getHomePageSections(sectionCallback: (section: HomeSection) => void): Promise<void> {
        ...
        request = createRequestObject({
            url: 'https://doctruyen3qme.com/hot',
            method: "GET",
        });
        ...
        //boy
        request = createRequestObject({
            url: 'https://doctruyen3qme.com/truyen-con-trai',
            method: "GET",
        });
        data = await this.requestManager.schedule(request, 1);
        $ = this.cheerio.load(data.data);
        ...
        //girl
        request = createRequestObject({
            url: 'https://doctruyen3qme.com/truyen-con-gai',
            method: "GET",
        });
        data = await this.requestManager.schedule(request, 1);
        $ = this.cheerio.load(data.data);
    ...
    async getViewMoreItems(homepageSectionId: string, metadata: any): Promise<PagedResults> {
        ...
        switch (homepageSectionId) {
            case "hot":
                url = `https://doctruyen3qme.com/hot?page=${page}`;
                break;
            case "new_updated":
                url = `https://doctruyen3qme.com/?page=${page}`;
                break;
            case "boy":
                url = `https://doctruyen3qme.com/truyen-con-trai?page=${page}`;
                break;
            case "girl":
                url = `https://doctruyen3qme.com/truyen-con-gai?page=${page}`;
                break;
            default:
    ...
    async getSearchResults(query: SearchRequest, metadata: any): Promise<PagedResults> {
        ...
        const request = createRequestObject({
            url: encodeURI(`https://doctruyen3qme.com/tim-truyen/${search.cate}?keyword=${query.title ?? ""}&sort=${search.sort}&status=${search.status}&page=${page}`),
            method: "GET",
        });
    ...
    async getSearchTags(): Promise<TagSection[]> {
        ...
        const url = 'https://doctruyen3qme.com/tim-truyen'
        const request = createRequestObject({
            url: url,
            method: "GET",
        });
