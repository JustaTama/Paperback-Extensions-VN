...
const DOMAIN = 'https://truyenvn.vip/'
const method = 'GET'
...
export class TruyenVN extends Source {
    ...
    async getHomePageSections(sectionCallback: (section: HomeSection) => void): Promise<void> {
        ...
        url = '';
        request = createRequestObject({
            url: 'https://truyenvn.vip/danh-sach-truyen',
            method: "GET",
        });
        ...
        url = DOMAIN
        request = createRequestObject({
            url: 'https://truyenvn.vip/truyen-hoan-thanh',
            method: "GET",
        });
    ...
    async getViewMoreItems(homepageSectionId: string, metadata: any): Promise<PagedResults> {
        ...
        switch (homepageSectionId) {
            case "new_updated":
                url = `https://truyenvn.vip/danh-sach-truyen/page/${page}`;
                break;
            case "new_added":
                url = `https://truyenvn.vip/truyen-hoan-thanh/page/${page}`;
                break;
            default:
    ...
    async getSearchResults(query: SearchRequest, metadata: any): Promise<PagedResults> {
        ...
        var url = '';
        if (search.name) {
            url = `https://truyenvn.vip/danh-sach-truyen/page/${page}?q=${search.name}`
        } else {
    ...
    async getSearchTags(): Promise<TagSection[]> {
        const tags: Tag[] = [];
        const request = createRequestObject({
            url: 'https://truyenvn.vip/the-loai-truyen',
            method: "GET",
        });
        ...
        const tags1: Tag[] = [
            {
                "id": "https://truyenvn.vip/truyen-hot",
                "label": "Top All"
            },
            {
                "id": "https://truyenvn.vip/top-ngay",
                "label": "Top Ngày"
            },
            {
                "id": "https://truyenvn.vip/top-tuan",
                "label": "Top Tuần"
            },
            {
                "id": "https://truyenvn.vip/top-thang",
                "label": "Top Tháng"
            },
            {
                "id": "https://truyenvn.vip/top-nam",
                "label": "Top Năm"
            }
        ]
